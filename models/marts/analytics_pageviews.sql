-- postgres_app_pages is too large, the dbt run keeps failing with the error that we don't have enoiugh space on the disk
-- I am commenting this out for now
-- and putting this code as a placeholder until we figure out how to increase space
-- 12/27/2022 - Natasha
...
SELECT *
FROM analytics_projects_all_not_deleted_src
